...
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'You may be interested in…', 'blockskit-base' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center"><a href="<?php echo esc_url( home_url( '/shop' ) ); ?>"><?php echo esc_html__( 'Browse store', 'blockskit-base' ); ?></a></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'New in store', 'blockskit-base' ); ?></h2>
<!-- /wp:heading -->
