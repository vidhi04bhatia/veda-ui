<?php
 /**
  * Title: Template 404
  * Slug: blockskit-marketing/template-404
  * Categories: template
  * Inserter: false
  */
...
<main class="wp-block-group" style="padding-bottom:0"><!-- wp:cover {"url":"<?php echo esc_url($blockskit_marketing_images[0]); ?>","id":79,"dimRatio":80,"overlayColor":"foreground","focalPoint":{"x":0.5,"y":0},"minHeight":700,"style":{"spacing":{"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|xx-large"}}}} -->
...
<p class="has-text-align-center"><?php esc_html_e( 'This page could not be found. Maybe try a search?', 'blockskit-marketing' ); ?></p>
<!-- /wp:paragraph -->
